...
/*----------------------------------------------------------*/
	...
	function AG_Recentprojects_Widget() {
		...
		$widget_ops = array( 'classname' => 'ag_recentprojects_widget', 'description' => __('A widget that displays small project thumbnails from recent portfolio items.', 'framework') );

		/* Widget control settings */
		$control_ops = array( 'width' => 400, 'height' => 350, 'id_base' => 'ag_recentprojects_widget' );

		/* Create widget */
		$this->WP_Widget( 'ag_recentprojects_widget', __('Custom Recent Portfolio Items Widget', 'framework'), $widget_ops, $control_ops );
	}
   ...
   <div class="recent-projects">
	 <?php while ( $loop->have_posts() ) : $loop->the_post(); ?>
        ...
        <div class="recent-project">
            <a href="<?php the_permalink(); ?>" class="hover"><?php the_post_thumbnail('tinyfeatured', array('class' => 'scale-with-grid')); ?></a>
        </div>
        <?php } ?>
