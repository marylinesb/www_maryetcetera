...
echo " <form action='".$url."' method='post' class='subForm' id='quickform' >
                ...
                <textarea name='c_message' id='c_message' rows='5' cols='5' class='required' onfocus='if(this.value==&quot;".__('Your Message', 'framework')."&quot;)this.value=&quot;&quot;;' onblur='if(this.value==&quot;&quot;)this.value=&quot;".__('Your Message', 'framework')."&quot;;'>".__('Your Message', 'framework')."</textarea>";
                		if ($captcha == 'on') : 
						echo '
								<label for="c_captcha" style="font-size: 10px; font-weight: bold; margin-top: -20px; display: block;">
										' .__('What is 5 - 1?', 'framework'). '
								</label>
								<input type="text" name="c_captcha" id="c_captcha" size="22" tabindex="4" class="required captcha" />
								<div class="clear"></div>';
						endif; 

                        echo "<input type='submit' name='c_submit' id='c_submit' class='button small light' value='";
