...
jQuery(document).ready(function($){
	...
	jQuery('.repeatable-add').click(function() {  
		...
		field.find('.ag_edit_link').hide();
		return false;  
	}); 
	jQuery('.repeatable-remove').click(function(){
		jQuery(this).closest('li').find('option[value="Select a Section:"]').val('selected');
		console.log(jQuery(this).closest('li').find('option[value="Select a Section:"]'));
...
/* Color Selector */
	...
	jQuery(".colorSelector").each(function($){
		var Othis = jQuery(this); //cache a copy of the this variable for use inside nested function
