 ...
 * @author Ryan Hellyer <ryan@metronet.no>
 */
define( 'REORDER_DIR', get_template_directory_uri() . '/framework/framework-functions'  ); 
define( 'REORDER_URL', get_template_directory_uri() . '/framework/framework-functions'  ); 
	...
	foreach ( $post_types as $post_type ) {
		...
		new Reorder(
			array(
				...
				'icon'        => get_template_directory_uri() . '/framework/admin/images/options-settings32.png',
				'post_status' => 'publish',
			)
		);
	}
